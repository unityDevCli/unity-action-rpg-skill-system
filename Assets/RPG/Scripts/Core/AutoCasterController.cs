...
namespace RPG.Scripts.Core
{
    ...
    {
        [Header("Targeting")] [SerializeField] private float searchRadius = 14f;
        [SerializeField] private LayerMask enemyLayer;
        [SerializeField] private float retargetInterval = 0.15f;

        [Header("Casting")] [SerializeField] private Transform firePoint;
        ...
        private void Update()
        {
            ...
            if (Time.time >= _nextCastTime)
            {
                ...
                var go = Instantiate(projectilePrefab, firePoint.position,
